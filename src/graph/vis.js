...
serv.setMethodFromFile('renderLoader', './incl/vis-render-loader');
serv.setMethodFromFile('renderLoader', './incl/vis-render');
serv.setPropertyFromFile('layout', './incl/layout-for-vis');
